-- Purpose: distinguish search-snippet follower references from exact Instagram follower counts.
-- Existing non-null follower values are exact because discovery did not persist follower counts before this migration.
